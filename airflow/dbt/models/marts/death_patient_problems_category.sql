...
with source as (
    select * from {{ ref('death_patient_problems_exploded') }}
),

death_patient_problems_category as (
    select
        event_key,
        patient_problem,
    ...
    WHEN patient_problem LIKE '%Thrombosis%'
         ...
         OR patient_problem LIKE '%Ischemia%'
        THEN 'Thromboembolic'
    ...
    WHEN patient_problem LIKE '%Endocarditis%'
         ...
         OR patient_problem LIKE '%Septic Shock%'
        THEN 'Infectious'
    ...
    WHEN patient_problem LIKE '%Aneurysm%'
         ...
         OR patient_problem LIKE '%Rupture%'
        OR patient_problem LIKE '%Laceration%'
...
select * from death_patient_problems_category
